...
class Runner:
    def __init__(self):
        self.n = 0
        self.divisibility = {1: False, 2: False, 3: False, 4: False, 5: False, 6: False, 7: False, 8: False, 9: False,
                             10: False, 11: False, 12: False, 13: False, 14: False, 15: False, 16: False, 17: False,
                             18: False, 19: False, 20: False}

    def fix_divisibility(self):
    ...
    def get_divisibility(self, n):
        ...
        functions = (
            isDivisibleBy1, isDivisibleBy2, isDivisibleBy3, isDivisibleBy4, isDivisibleBy5, isDivisibleBy7,
            isDivisibleBy8,
            isDivisibleBy9, isDivisibleBy10, isDivisibleBy11, isDivisibleBy13, isDivisibleBy16, isDivisibleBy17,
            isDivisibleBy19, isDivisibleBy20)
        ...
        for i, fn in enumerate(functions):
            ...
            self.divisibility[i] = True

        if should_fix: self.fix_divisibility()

    def return_divisibility(self):
